...
1. Load the provided GloVe embeddings and choose two sets of new words related to current events (e.g., "AI," "climate," "democracy") and investigate the 10 most similar words. Do these embeddings make sense to what you have given as input?
...
4. Extend the analysis by creating your own bias anchors (e.g., political biases such as "liberal" vs. "conservative" or political parties, sociological conepts) and test the biases of terms.
