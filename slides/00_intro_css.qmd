...
format: 
    revealjs:
        ...
        footer: "Jan & Sattelmayer -- SciencesPo, CEE"
        self-contained: true
...
- Malo Jan
    - 4th year PhD student at the CEE working on Climate politics, Party politics, Quantitative and computational methods
    - [malo.jan@sciencespo.fr](malo.jan@sciencespo.fr)
    - [https://malojan.github.io/website/](https://malojan.github.io/website/)
    
- Luis Sattelmayer
    - 4th year PhD student at the CEE working on Party Competition, Partisan Strategies, Immigration Politics, Quantitative and computational methods
    - [luis.sattelmayer@sciencespo.fr](luis.sattelmayer@sciencespo.fr)
    - [https://luissattelmayer.github.io/website/](https://luissattelmayer.github.io/website/)
...
| 4 | Embeddings | Embeddings in R and Python | Coding session |
| 5 | Large language models (LLMs) | LLMs in Python & R | Open |
...
::::::: {.columns}
::: {.column width="50%"}
![](images/00_jcss.png){width="70%"}
:::

::: {.column width="50%"}
![](images/00_sicss.png)
- Computational Social Science (CSS) is an interdisciplinary field at the intersection of social sciences, computer science, and data science.
...
- New methods and computing power 
    - More powerful computers and hardware (mostly GPUs)
    - More powerful algorithms, methods, models, IA
    - Allows to train more complex models: advent of LLMs
...
- Capture *latent meaning* in text
  ...
  - Or we can use more deductive reasoning beforehand to nudge the method toward a specific underlying pattern of interest (supervised)
...
2. Text analysis does not replace humans -- it augments them (see also @do2024augmented)
