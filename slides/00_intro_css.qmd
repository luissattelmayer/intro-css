...
- Existing API :  :Guardian, New York Times, Spotify, [Bluesky](https://github.com/JBGruber/atrrr) 
- Apycalypse : Facebook, or Twitter that had before extensive API access for researchers but now closed (see [minet](https://github.com/medialab/minet) for some workarounds)
