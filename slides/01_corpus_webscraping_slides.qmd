...
- Every project involving text/image/videos analysis starts with a corpus 
- A collection of *machine readable* texts/images/videos, along with metadata
...
- Think about data generation process
    - How were these documents produced?
    - How could this affect the corpus?
- Important to explore, read some of the documents
- Think about quantity of interest,  what could you derive as a measure from those documents : 
    - eg. How much a given topic is discussed in these texts
    - eg. How much a given sentiment is expressed in these texts
    
## Potentiel Biases in text selection {.smaller}
...
- A common way to access and share data online
- Set of rules that allows one software application to communicate with another.
- Defines what requests can be made, how to make them, and the data formats to be used.
:::
...
- Accessing data usually involves : 
    - Authenticating with an API key or token
    - Sending requests with specific parameters
    - Receiving structured data (e.g., JSON or XML)
...
- CTRL + U/⌘-Option-U to see the source code of a web page
