...
- A corpus is a collection of texts, along with metadata
- Corpus selection is a crucial task and often overlooked
- Corresponds to identifying the population of interest, choosing documents to analyze according to research questions and interests
...
- Think about data generation process : how these texts were produced, how does it affect the corpus
    - Eg. Censorship [@king2013censorship]
...
- Collecting digital texts
    - Digitizing texts : through Optical Character Recognition (OCR) 
