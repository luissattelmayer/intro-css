...
unsg_df |>
    ...
    summarise(
        ...
        climate_dict_three = mean(str_detect(text, "climate change|climate emergency|climate crisis|global warming|greenhouse gas"))
    ) |>
    pivot_longer(
    ...
    geom_line(size = 1)  +
    scale_color_manual(values = c("#0038B8", "#007A33"), labels = c("climate change|global warming|greenhouse gas", "climate|global warming|greenhouse gas")) +
    theme_light() +
